            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-line bg-overlay-5">
                  <th className="text-left px-3 py-2 text-sm font-medium text-fg-muted">Admin</th>
                  <th className="text-left px-3 py-2 text-sm font-medium text-fg-muted">Action</th>
                  <th className="text-left px-3 py-2 text-sm font-medium text-fg-muted">Target</th>
                  <th className="text-left px-3 py-2 text-sm font-medium text-fg-muted">Details</th>
                  <th className="text-right px-3 py-2 text-sm font-medium text-fg-muted">Date</th>
                </tr>
              </thead>
              <tbody>
                {logs?.map(log => (
                  <tr key={log.id} className="border-b border-line-soft last:border-0 hover:bg-[#7C3AED]/5 transition-colors">
                    ...
                    <td className="px-3 py-2 text-sm text-fg capitalize">{log.target_type ?? '—'}</td>
                    <td className="px-3 py-2 text-sm text-fg max-w-xs truncate">
                ...
                {logs?.length === 0 && (
                  <tr><td colSpan={5} className="px-3 py-6 text-center text-fg-muted">No activity logs yet</td></tr>
                )}
              </tbody>
            </table>
          </div>
