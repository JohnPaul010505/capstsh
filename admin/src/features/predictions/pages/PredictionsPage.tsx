    ...
    <div className="space-y-3">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
        <div className="glass-card p-4 rounded-xl">
          ...
          <p className="text-xs text-fg-muted mt-1">Generated by AI</p>
        </div>
        <div className="glass-card p-4 rounded-xl">
          <div className="flex items-center gap-2 text-sm text-fg-muted mb-1">
          ...
          <div className="flex items-center gap-2">
            <select
              ...
              className="flex-1 px-3 py-2 bg-overlay-8 border border-line rounded-lg text-sm text-fg-strong focus:outline-none focus:ring-2 focus:ring-[#7C3AED]/50"
            >
      ...
      {aiResults && aiResults.length > 0 && (
        <div className="bg-gradient-to-r from-[#7C3AED]/10 to-[#3B82F6]/10 p-4 rounded-xl border border-[#7C3AED]/30 shadow-sm">
          <h2 className="text-base font-semibold mb-3 text-fg-strong">Latest AI Results</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
            {aiResults.map((r, i) => (
